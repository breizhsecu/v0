	...
	<table class="table table-bordered table-condensed">
              ...
              ?>
                <tr>
                  ...
                  <td><b><?php echo $produit['titre']; ?></b><br><?php echo $donnees['description']; ?></td>
                  <td>000<?php echo $donnees['idproduit']; ?></td>
                  <td><?php echo $donnees['prix']; ?> &euro;</td>
                  <td>
					<input class="span1" style="max-width:34px" placeholder="1" id="appendedInputButtons" size="16" type="text" value="<?php echo $donnees['qte']; ?>" disabled>
